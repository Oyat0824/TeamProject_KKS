			...
			<div class="flex flex-col mb-3">
				...
				<div class="flex border border-t-0">
					<c:if test="${item.cancel == 0 && item.confirm == 1 && item.isReview == 0}">
						<a class="flex-auto block py-3 text-center" href="review?storeId=${item.storeId}&productId=${item.productId}&purchaseId=${item.id}" onclick="window.open(this.href, '_blank', 'width=600, height=800'); return false;">리뷰쓰기</a>
					</c:if>
