...
<c:set var="pageTitle" value="Store CheckPassword" />
<%@ include file="../common/head.jsp"%>

<script>
	//Submit 전 검증
	const StoreLogin__submit = function(form) {
		// 비밀번호 검증
...
<section class="mt-8 text-xl">
	<div class="container mx-auto px-3">
		<form action="doChkPassword" method="POST" onsubmit="return StoreLogin__submit(this);">
